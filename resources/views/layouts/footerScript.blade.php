...
<!-- <link rel="stylesheet" type="text/css" href="{{asset('assets/js/bootstrap-4-navbar.js')}}"> -->
...
<script src="{{asset('assets/js/initiate.js')}}" ></script>
<script src="{{asset('assets/js/earn.js')}}" ></script>
