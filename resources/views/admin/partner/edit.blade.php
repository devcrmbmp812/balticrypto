...
@section('title') BCT Coin  | Partner Edit @endsection
@section('style')
<style type="text/css">
.badge-warning {
...
<div class="dashboard-body">
  <div class="row">
    <div class="col-sm-12">
      ...
      <li class="breadcrumb-item"><a href="#">Partner Edit</a>
    </li>
  </ol>
</div>
</div>
  ...
  @if(session('success'))<br><div class="alert alert-success">{{ session('success') }}</div><br>@endif
    ...
    <div class="form-group">
      <div  class="row">
        ...
        <div class="col-sm-2">
          <input type="text" name="link"  class="form-control" value="{{$partner->link}}"  autocomplete="off">
        </div>
      </div>
    </div>
    ...
    <div class="form-group">
      <div  class="row">
        ...
        <div class="col-sm-2">
          <img src="{{URL::asset('assets/images/user/partner').'/'.$partner->image}}" width="200px" height="200px">
          </div>
      </div>
    </div>
