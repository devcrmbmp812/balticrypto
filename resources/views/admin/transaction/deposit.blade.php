              ...
              @foreach($deposit as $key)
               @if($key->status != 0)
                 <tr>
                   ...
                   <td>@if($key->coin_type== 'BTC') <span class="badge badge-warning">BTC</span>  @elseif($key->coin_type== 'BCH') <span class="badge badge-primary">BCH</span>@elseif($key->coin_type== 'ETH') <span class="badge badge-info">ETH</span>  @endif </td>
                   <td>{{$key->txid}}</td>
