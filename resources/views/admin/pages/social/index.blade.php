...
<!-- Modal content-->
              ...
              <form class="form-horizontal" action="{{ url('admin-storeLink',$key->id) }}" method="post" enctype="multipart/form-data">
      ...
      <input type="hidden" name="_token" value="{{csrf_token()}}">
                ...
                <input type="text" class="form-control" name="link" value="{{ $key->link }}" id="exampleInputEmail1" autocomplete="off" >
                 <div class="form-group col-md-12">
