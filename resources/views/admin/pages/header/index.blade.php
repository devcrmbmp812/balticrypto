...
<div class="col-sm-12">
   ...
   <div class="card">
    ...
    <tr>
      <td>1</td>
      <td><img src="{{url('assets/images/frontend',$home->images)}}" style="width: 250px;height: 100px"></td>
...
<!-- Modal content-->
              ...
              <form class="form-horizontal" action="{{ url('admin-storeLogo',$home->id) }}" method="post" enctype="multipart/form-data">
