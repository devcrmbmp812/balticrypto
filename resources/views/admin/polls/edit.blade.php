...
<div class="dashboard-body">
  <div class="row">
    <div class="col-sm-12">
      <h4 class="page-title">Edit Polls</h4>
      <ol class="breadcrumb">
...
<div class="col-sm-12">
  ...
  {{ Form::model($poll, array('route' => array('polls.update',$poll->id), 'method' =>'PUT', 'files' => 'true')) }}
    <div class="row">
      <div class="col-sm-6"><h2>Edit Polls</h2></div>
    ...
    <div class="form-group">
    	<div  class="row">
    		...
    		<div class="col-sm-2">
    			<input type="text" name="question" value="{{$poll->question}}" class="form-control"  autocomplete="off">
    		</div>
    	</div>
    </div>
    <div class="form-group">
    ...
    @foreach($options as $option)
      ...
      <div class="form-group">
        <div  class="row">
          ...
          <div class="col-sm-2">
            <input type="radio" name="answer" value="<?php echo $i+1; ?>"  <?php if($poll->answer == $i+1) { echo "checked"; } ?>   />
   ...
   <!--  <div class="form-group"> 
    ...
    <div class="form-group">
    	<div  class="row">
    		<div class="col-sm-2">
				  <input type="submit" class="btn-sign-in btn btn-sm mb-3  @if(!session('validator')) active @endif" value="Update Poll">
    		</div>
