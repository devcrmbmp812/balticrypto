            ...
            <div class="tab signin-up" role="tabpanel">
              ...
              <div class="tab-content tabs">
                ...
                <div role="tabpanel" class="tab-pane fade in   @if(!session('validator') && $ref == "default" ) active show  @endif " id="signin">
                  ...
                  <form class="form-horizontal access-form"   action="{{ url('doLogin') }}" method="post">
                    {{ csrf_field() }}
                    <div class="row">
                    ...
                    <!-- <div class="form-group">
                      {{--<button type="submit" class="btn theme-btn btn-sign-in btn-sm mr-3">Sign in</button>--}}
                      {{--<a  href="#signup" class=" btn theme-btn btn-sm  @if(session('validator')) active @endif" aria-controls="profile" role="tab" data-toggle="tab">sign up</a>--}}
                      <ul class="nav " role="tablist">
                        <li role="presentation" class="mr-2"> <input type="submit" class="btn theme-btn btn-sm" value="Sign In" ></li>
                        <li role="presentation"> <a  href="{{ url('register') }}" class=" btn theme-btn btn-sm ">Sign Up</a></li>
                       </ul>
                    </div>
                    <hr> -->
