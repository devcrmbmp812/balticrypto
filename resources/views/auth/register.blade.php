              ...
              <div class="tab-content tabs">
               ...
               <!--  @if ($errors->any())
                ...
                @endif -->
                  ...
                  <form class="form-horizontal access-form" action="{{url('doRegister')}}" name="register-form" id="register-form" method="post" >
                    <div class="row">
                    ...
                    <div class="form-group form-row erc_20_address">
                        <input type="text" name="erc_20_address" value="{{old('erc_20_address')}}" onchange="checkaddress(this.value)" class="form-control" id="erc_20_address" autocomplete="off" placeholder="Enter ERC 20 Address To Receive Tokens & Your Rewards">
                              @if ($errors->has('erc_20_address'))
                            <span class="help-block text-danger">
                              <strong id="error_address">{{ $errors->first('erc_20_address') }}</strong>
                            </span>
                            @endif
                   ...
                   <!--  <ul class="nav " role="tablist">
                      <li role="presentation" class="mr-2"> <input type="button" class="btn theme-btn btn-sm" value="Sign Up" id="register" onclick="checkReferral()"></li>
                       <li role="presentation" class="mr-2"> <a href="{{ url('login') }}" class=" btn theme-btn btn-sm ">Sign In</a></li>
                        </ul> -->
