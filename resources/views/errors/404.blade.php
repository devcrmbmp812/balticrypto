...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="{{ URL::asset('assets/css/owl.theme.default.css') }}">
   <!-- Parallax.css-->
   <link rel="stylesheet" type="text/css" href="{{ URL::asset('assets/css/jarallax.css') }}">
   <!-- Bootstrap css -->
    ...
    <div class="container">
      <div class="row">
         <div class="col-sm-12 text-center">
            ...
            <h2>The page</h2>
            <h3>Was Not found</h3>
            <a class="theme-btn" href="{{ url('/') }}">Back to home</a>
         </div>
      </div>
   </div>
</section>
     ...
     <!--Jarallax JS-->
     <script src="{{ URL::asset('assets/js/jarallax.min.js') }}"></script>
     <!--OWL Carousel JS -->
