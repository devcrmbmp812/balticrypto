                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="scale-90" width="490">
                           ...
                           <tr>
                              <td align="left" style="font-family: 'Ubuntu', sans-serif; font-size: 14px; color: #1c1c1c; line-height: 28px;" mc:edit="copy4">
                                 <p>
                                 <h4 style="font-weight: normal; font-size: 15px; line-height: 23px;">We have received a request to reset the password for your account. If you did not request to reset your passwod, please ignore this email.</h4>
                                 <a href="{{ url('/') }}/reset/{{ $user->email }}/{{ $code }}"> {{ url('/') }}/reset/{{ $user->email }}/{{ $code }}</a>
                                 </p>
                              </td>
                           </tr>
                        </table>
