                  ...
                  <tr>
                     <td align="center">
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="scale-90" width="490">
                           <tr>
                              <td>
                                 <h1 style="    font-family: 'Ubuntu', sans-serif;">System Mail</h1>
                                 <br>
                           ...
                           <tr>
                              <td align="left" style="font-family: 'Ubuntu', sans-serif; font-size: 14px; color: #1c1c1c; line-height: 28px;" mc:edit="copy4">
                                 <p>
                                 <h4 style="font-weight: normal; font-size: 15px; line-height: 23px;">This is System automated mail , Now system using coinmarketcap api.  </h4>
