...
@section('title') BCT Coin | Network @endsection
@section('style')
<style type="text/css">
...
<div class="dashboard-body">
  <div class="row">
    <div class="col-sm-12">
      ...
      <li class="breadcrumb-item"><a href="{{ URL('user-referral')}}">Network</a>
    </li>
  </ol>
            ...
            <ul>
                <li class="folder folder-open">
                    ...
                    <ul>
                        ...
                        <li class="file">(F1) {{$user->first_name}} {{$user->last_name}} <span class="badge  default default-badge"> {{number_format($user->total_wdc_bal,0)}} BCT </span> </li>
                        @endforeach
                    </ul>
                </li>
            </ul>
