              ...
              @foreach($wallets as $key)
                 ...
                 <tr>
                   ...
                   <td>
                    ...
                    @endif</td>
                   <td>{{$key->tokens}}</td>
                   <td>@if($key->type==1) <span class="badge badge-warning">BTC</span>  @elseif($key->type == 2) <span class="badge badge-info">ETH</span>@elseif($key->type == 4) <span class="badge badge-success">BCH</span>   @elseif($key->type == 3) <span class="badge default default-badge">USD</span> @endif </td>
                    <td>{{ $key->txid }} </td>
                    <td><span class="badge default default-badge">Confirm</span></td>
                   <td>{{$key->created_at}}</td>
                   <td>User Bought Token With @if($key->type==1) BTC @elseif($key->type == 2) ETH @elseif($key->type == 4) BCH  @elseif($key->type == 3) USD @endif Wallet.</td>
