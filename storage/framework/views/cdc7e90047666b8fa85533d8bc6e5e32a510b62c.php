              ...
              <div class="tab-content tabs">
               ...
               <!--  <?php if($errors->any()): ?>
                ...
                <?php endif; ?> -->
                  ...
                  <form class="form-horizontal access-form" action="<?php echo e(url('doRegister')); ?>" name="register-form" id="register-form" method="post" >
                    <div class="row">
                      <div class="col-sm-12 text-center"><h2 class="mb-0 login-top-section">Sign Up Now.</h2></div>
                    ...
                    <div class="form-group form-row erc_20_address">
                        <input type="text" name="erc_20_address" value="<?php echo e(old('erc_20_address')); ?>" onchange="checkaddress(this.value)" class="form-control" id="erc_20_address" autocomplete="off" placeholder="Enter ERC 20 Address To Receive Tokens & Your Rewards">
                              <?php if($errors->has('erc_20_address')): ?>
                            <span class="help-block text-danger">
                              <strong id="error_address"><?php echo e($errors->first('erc_20_address')); ?></strong>
                            </span>
                            <?php endif; ?>
                    ...
                    <div class="row mt-3 mb-3 pr-3 pl-3 form-footer">
                      ...
                      <div class="col-sm-12">
                        <input type="button" class="btn theme-btn btn-sm registerbtn" value="Join Now" id="register" onclick="checkReferral()">
                      </div>
                      <div class="col-sm-12 mt-3 mb-3 text-center">
                        <a href="/login" ui-link="secondary underlined">Already have an account? Sign in.</a>
                      </div>
                    </div>
                   <!--  <ul class="nav " role="tablist">
                      <li role="presentation" class="mr-2"> <input type="button" class="btn theme-btn btn-sm" value="Sign Up" id="register" onclick="checkReferral()"></li>
                       <li role="presentation" class="mr-2"> <a href="<?php echo e(url('login')); ?>" class=" btn theme-btn btn-sm ">Sign In</a></li>
                        </ul> -->
