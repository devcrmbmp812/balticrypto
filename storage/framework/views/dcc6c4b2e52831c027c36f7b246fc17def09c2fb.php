...
<div class="container">
    <div class="row">
        <div class="col-md-5 mobile-text-center">
            <div class="home-coin">
            <a href="<?php echo e(url('smart-token')); ?>"><img src="<?php echo e(asset('assets/images/coin.png')); ?>"></a>
            </div>
            ...
            <div class="mt-4">
            <a href="<?php echo e(url('/')); ?>/#home-ico" class="theme-btn mr-3">ICO details</a>
            <a  target="_blank" href="<?php echo e(url('assets\images\Whitepaper.pdf')); ?>" class="theme-btn">White paper</a>
            </div>
        </div>
        <div class="col-md-7 bg-right text-center">
            ...
            <div class="prices">
                <div>
                    ...
                    <h2 class="">USD $<?php echo e(number_format($seting->rate,2)); ?></h2>
                </div>
                <div>
                    <h4>Bouns:</h4>
                    <h2><span class=""><?php echo e($seting->bonus); ?>%</span></h2>
                </div>
            </div>
                <div class="row">
                    <div class="col-sm-12">
                        <div>
                            ...
                            <a href="<?php echo e('https://whitelist.balticrypto.io'); ?>" class="theme-btn btn-gradiant btn-glow">Join the Whitelist Now!</a>
                        </div>
                        <p> We accept<br>
                           <b>ETH, BTC, LTC </b>
                        </p>
            ...
            <div class="mt-61">
                ...
                <a href="#" class="theme-btn btn-inverse mr-4"><span>BCT sold<br/></span><?php echo e(number_format($seting->sold_coins)); ?></a>
                <a href="#" class="theme-btn btn-inverse  mr-4"><span>Contributors<br/></span><?php echo e($count_user); ?></a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-md-6 mobile-text-center responsive-mt-70 reveal-right">
                <div class="row">
                    ...
                    <div class="col-md-12 about-us-content">
                        ...
                        <a href="<?php echo e(url('about')); ?>" class="theme-btn mr-3">read more</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-8 intro-text offset-md-2 reveal-right">
                            ...
                            <div class="text-center">
                                <a href="<?php echo e(url('smart-token')); ?>" class="theme-btn mr-3 text-center">read more</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="charts clip-section-bg" id="home-ico">
    <div class="container mb-150">
        ...
        <div class="col-sm-12 mb-5 pt-150 text-center reveal-right">
                ...
                <div><a href="<?php echo e(url('ico')); ?>" class="theme-btn mb-5">Read more</a></div>
        </div>
        ...
        <div class="col-sm-12 mb-5 mt-5 text-center reveal-bottom">
                ...
                <div><a href="<?php echo e(url('ico')); ?>" class="theme-btn">Read more</a></div>
        </div>
    </div>
    </div>
</section>
                ...
                <div class="ecovers12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <a href="<?php echo e(url('renewable-energy')); ?>" class="hex-inner-1"><img class="float-right" src="assets/images/home/Renewable.png"></a>
                                </div>
                                <div class="col-sm-4">
                                    <a href="<?php echo e(url('smart-impact')); ?>" class="hex-inner-2"><img class="float-right" src="assets/images/home/Foundation.png"></a>
                                </div>
                                <div class="col-sm-4">
                                    <a href="<?php echo e(url('mining')); ?>" class="hex-inner-3"><img class="float-right" src="assets/images/home/Mining-Farm.png"></a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-4">
                                    <a href="<?php echo e(url('crypto-university')); ?>" class="hex-inner-4"><img class="float-right" src="assets/images/home/University.png"></a>
                                </div>
                                <div class="col-sm-4">
                                    <a href="<?php echo e(url('smart-token')); ?>" class="hex-inner-5"><img class="float-right" src="assets/images/home/Smart-Hybrid-Token.png"></a>
                                </div>
                                <div class="col-sm-4">
                                    <a href="<?php echo e(url('debit-ico-ideas')); ?>" class="hex-inner-6"><img class="float-right" src="assets/images/home/Debit-Card.png"></a>
                                </div>
                            </div>
                        </div>
                        </div>
                    ...
                    <div class="row ecovers-main-div">
                        <div class="col-sm-12">
                            <div class="row">
                                <div class="col-sm-6">
                                    <a href="<?php echo e(url('media-property-empowerment')); ?>" class="hex-1"><img class="float-right" src="assets/images/home/Media.png"></a>
                                </div>
                                <div class="col-sm-6">
                                    <a href="<?php echo e(url('newindustry-investorinstruments-research')); ?>" class="hex-2"> <img class="float-left" src="assets/images/home/Integration.png"></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="row">
                                <div class="col-sm-4">
                                   <a href="<?php echo e(url('debit-ico-ideas')); ?>" class="hex-3"> <img class="float-right" src="assets/images/home/Ideas.png"></a>
                                </div>
                                <div class="col-sm-4">
                                </div>
                                <div class="col-sm-4">
                                    <a href="<?php echo e(url('newindustry-investorinstruments-research')); ?>" class="hex-4"><img class="float-left" src="assets/images/home/Instruments.png">
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="row">
                                <div class="col-sm-3">
                                    <a href="<?php echo e(url('debit-ico-ideas')); ?>" class="hex-5"><img class="float-right" src="assets/images/home/Ico.png"></a>
                                </div>
                                <div class="col-sm-6">
                                </div>
                                <div class="col-sm-3">
                                    <a href="<?php echo e(url('newindustry-investorinstruments-research')); ?>" class="hex-6"><img class="float-left" src="assets/images/home/Blockchain.png"></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="row">
                                <div class="col-sm-4">
                                    <a href="<?php echo e(url('academy')); ?>" class="hex-7"><img class="float-right" src="assets/images/home/Trading.png"></a>
                                </div>
                                <div class="col-sm-4">
                                </div>
                                <div class="col-sm-4">
                                    <a href=" <?php echo e(url('exchange')); ?>" class="hex-8"><img class="float-left" src="assets/images/home/Exchange.png"></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="row">
                                <div class="col-sm-6">
                                    <a href="<?php echo e(url('media-property-empowerment')); ?>" class="hex-9"><img class="float-right" src="assets/images/home/Property.png"></a>
                                </div>

                                <div class="col-sm-6">
                                    <a href="<?php echo e(url('media-property-empowerment')); ?>" class="hex-10"><img class="float-left" src="assets/images/home/Empowerment.png"></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="inner">
                        <div class="textWrapper text-center">
                            <div class="range-slider-div">
                                ...
                                <h4 class="text-white">
                                    With current discount<br><span class="orange-font-color">$<?php echo e(number_format($seting->rate,2)); ?> + <?php echo e($seting->bonus); ?>% bonus</span>
                                </h4>
                                <div class="bonus">
                Current discount <strong><?php echo e($seting->bonus); ?>%</strong> <span class="hide-toggle"><span class="on">Hide</span><span class="off">Show</span></span>
            </div>
...
from direct speculation in all crypto currencies.</p>
        ...
        <div class="col-sm-12 text-center reveal-top">
            <div><a href="<?php echo e(url('smartreward')); ?>" class="theme-btn mt-3 mb-5">Read more</a></div>
        </div>
...
<section class="bg-black team-wrapper jarallax" id="home-team"  data-jarallax="{&quot;speed&quot;: 0.2}" style="background-image: url(assets/images/team.jpeg);" >
    <div class="container">
        ...
        <div class="row team-member">
            ...
            <div class="col-md-2 col-sm-6 <?php echo e($loop->iteration==1?'offset-md-1':''); ?>   <?php echo e(is_float($loop->iteration/2)? ' reveal-bottom':'  reveal-top'); ?>">
                <div class="our-team">
                    <div class="pic">
                        <img src="<?php echo e(asset('assets/images/user/team_member').'/'.$key->image); ?>" alt="">
                    ...
                    <div class="team-prof">
                        <h3 class="post-title"><?php echo e($key->name); ?></h3>
        ...
        <!-- sub team -->
                ...
                <?php $__currentLoopData = $team; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(in_array($loop->iteration, [1,6,11,16])): ?>

                        <div class="row team-member-bottom margin-52">
                            <div class="col-md-1 "></div>
                            <?php endif; ?>
                            <?php if(in_array($loop->iteration, [16])): ?>
                                <div class="col-md-2 col-sm-6  <?php if(in_array($loop->iteration, [6,7,8,9,10,16,17,18,19,20])): ?>reveal-left  <?php else: ?> reveal-right  <?php endif; ?>">
                                    <div class="our-team">
                                        <div class="pic">
                            ...
                            <?php if(in_array($loop->iteration, [5,10,15,20])): ?>
                                    <div class="col-md-1"></div>
        ...
        <div class="col-sm-12 text-center reveal-bottom">
            <div><a href="<?php echo e(url('team')); ?>" class="theme-btn mt-5 mb-5 text-white">GET TO KNOW US</a></div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <!-- <div id="partner-slider" class="owl-carousel owl-theme partner-slider mt-5">
                <?php $__currentLoopData = $negotiation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e($key->link); ?>" target="_blank" > <div class="item" ><img src="<?php echo e(URl::asset('assets/images/user/negotiation').'/'.$key->image); ?>" /></div></a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>-->
            ...
            <div class="col-sm-8 offset-sm-2 mt-5 text-center pt-100 reveal-left">
                <ul class="theme-group partner-group">
                   ...
                   <?php $__currentLoopData = $partner; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="<?php echo e($key->link); ?>" target="_blank"><img src="<?php echo e(URl::asset('assets/images/user/partner').'/'.$key->image); ?>" /></a>
                        </li>
...
<?php $__env->stopSection(); ?> <?php $__env->startSection('bottom_script'); ?>
...
<script>
    ...
    var countDownDate = new Date("<?php echo e($date); ?>").getTime();
