  ...
  function Timeline(cvs) {
    ...
    self.dotColors = [
        ['#f7941e', 'rgba(0, 0, 0, 0.3)', 'rgba(247,148,30,.3)'],
       ['#f7941e', 'rgba(0, 0, 0, 0.3)', 'rgba(247,148,30,.3)'],
    ];
    ...
    function InitDots() {
       ...
       // alert(top);
        ...
        tl.find('article:first figure').each(function () {
            ...
            self.lines[0].dots.push([$(this).outerWidth() + 40, y + 50]);
            //var y = "20";
            y += 78;
        ...
        tl.find('article:last figure').each(function () {
            ...
            self.lines[1].dots.push([canvas.width - $(this).outerWidth() - 20, y + 50]);
    ...
    function init() {
        ...
        try {
            ...
            self.lines[0] = new Line(0, canvas.offsetHeight - 100, 'rgba(247,148,30,.3)', self.options, mouse);
            self.lines[1] = new Line(0, canvas.offsetHeight - 100, 'rgba(247,148,30,.3)', self.options, mouse);
