...
class BountyController extends Controller
{
    ...
    public function index()
    {
        ...
        $user_id = $user->id;
         return view('bounty.index',compact('bounty_data'));
    }

    public function screen_upload($serv)
    {
    	return view('bounty.upload_screen',compact('serv'));
    }
    ...
    public function upload_screen1(Request $request)
    {
            ...
            $user_id=$user->id;
                ...
                $set->save();
                return redirect('bounty-dash')->with(['success'=>'Document Upload Successfully']);
