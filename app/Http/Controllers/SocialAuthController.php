...
class SocialAuthController extends Controller 
{
	...
	public function goto_ser($service)
	{
		...
		return view ( 'bounty.otherhome',compact('other_data','service') );
	}
	...
	public function callback($service) 
	{
	   try {
        		...
        		return view ( 'bounty.home',compact('fb_data','tw_data') )->withDetails ( $user )->withService ( $service );
            } catch (Exception $e) {
                return redirect('bounty-dash');
            }
